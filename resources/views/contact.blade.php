        ...
        <div class="contact_detail">
          ...
          <ul>
            <li>
              ...
              <div class="contact_info_m">Jakarta, bali, bandung</div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:61-1234-567-90">081299982701</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:contact@exampleurl.com">rental.ngerental@gmail.com</a></div>
            </li>
          </ul>
        </div>
      </div>
